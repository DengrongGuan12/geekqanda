        ...
        <section class="widget small">
            ...
            <div class="content">
                <div class="field-wrap">
                    设置新头像<br /><br />
                    <form onsubmit="return uploadPic();" action="<?php echo($address."pages/do_upload");?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                    ...
                    <script type="text/javascript">
                        function uploadPic(){
                            ...
                            var url = "http://www.geekqanda.sinaapp.com/index.php/pages/do_upload";
                            var ajax = null;
...
//                                    pass1.setCustomValidity("");
                                    ...
                                    var msg = document.getElementById('msg');
                                    //接收表单的URL地址
                                    var url = "http://www.geekqanda.sinaapp.com/index.php/pages/changePassword";
...
//            return true;
    ...
    <div class="widget-container">
        <section class="widget small">
            ...
            <span class="show-more" style="margin-left: 36px"><a	 href="<?php echo($address."question/my_all_questions/");?>">更多</a></span>
            <?php endif;?>
        </section>
        ...
        <section class="widget small">
                ...
                <?php else:?>
                    <?php foreach(array_keys($Acontents) as $id):?>
                        <div class="mini-answer" style="height: 70px;">
                            <p>
                                <a title="进入问题" href=<?php echo ($address."question/single_question/".$AqIds[$id]);?>>
            ...
            <?php if(count($Acontents)>0):?>
            <span class="show-more" style="margin-left: 36px"><a	 href="<?php echo($address."question/my_all_answers/");?>">更多</a></span>
            <?php endif;?>
        </section>
